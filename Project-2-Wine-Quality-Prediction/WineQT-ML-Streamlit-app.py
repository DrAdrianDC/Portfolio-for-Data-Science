...
state = st.query_params.get("state", "project_description")
...
if state == "project_description":
    ...
    st.image('https://github.com/DrAdrianDC/Portfolio-for-Data-Science/raw/main/Project-2-Wine-Quality-Prediction/wine-Porto-2019.png', caption='Photo by the author during a trip to Porto, Portugal in November 2019', width=500)
    ...
    st.write(" * XGBoost (92.89%)")
    st.write(" * Random Forest (89.59%)")
    st.write(" * Deep Neural Network (87.82%)")
    st.write(" * Logistic Regression (84.77%)")
...
# Crear botones y cajas de texto para ingresar los datos
     ...
     # model_url = 'https://github.com/DrAdrianDC/Portfolio-for-Data-Science/raw/main/Project-2-Wine-Quality-Prediction/XGBoost/XGBoost_joblib.pkl'
      model_url = 'https://github.com/DrAdrianDC/Portfolio-for-Data-Science/blob/main/Project-2-Wine-Quality-Prediction/XGBoost_joblib.pkl'
