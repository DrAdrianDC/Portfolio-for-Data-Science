...
if state == "project_description":
    ...
    st.markdown("---")
    # Add an image
    st.image('https://github.com/DrAdrianDC/Portfolio-for-Data-Science/blob/main/Project-1-Wine-Quality-Prediction/DSC01511.JPEG', caption='Photo by the author during a trip to Porto, Portugal in November 2019', width=500) #use_column_width=True)
